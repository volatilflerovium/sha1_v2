...
void test_standard()
{
    ...
    compare(checksum("abc"), "a9993e364706816aba3e25717850c26c9cd0d89d");

    cout << endl;
    cout << "Test:     abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq" << endl;
    result=checksum("abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq");
    compare(result, "84983e441c3bd26ebaae4aa1f95129e5e54670f1");
    ...
    result=checksum("abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu");
    compare(result, "a49b2446a02c645bf419f995b67091253a04a259");
    ...
    result=checksum("The quick brown fox jumps over the lazy dog");
    compare(result, "2fd4e1c67a2d28fced849ee1bb76e7391b93eb12");

    cout << endl;
    cout << "Test:     The quick brown fox jumps over the lazy cog" << endl;
    result=checksum("The quick brown fox jumps over the lazy cog");
    compare(result, "de9f2c7fd25e1b3afad3e85a0bd17d9b100db4b3");
}
...
void test_slow()
{
    ...
    cout <<"\ntest_slow()"<< endl;
    cout << "Test:     16,777,216 repetitions of abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmno" << endl;
...
void test_other()
{
    ...
    std::string tmp("a" "\x00" "b" "\x7f" "c" "\x80" "d" "\xff" "e" "\xc3\xf0" "f", 12);
    checksum.update(tmp);
...
int main(int argc, const char *argv[])
{
    if (argc > 1)
    {
        ...
        {
            if(checksum(argv[i], hash))
            {
					cout<<hash<< " *" << argv[i] << endl;
				}
				else{
					cout<<"Error: " << checksum.getError() << endl;
				}
        }
    }
    else
